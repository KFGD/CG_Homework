...
void CGApplication::renderScene()
{
	...
	// LIGHT0 설정
	glLightfv(GL_LIGHT1, GL_AMBIENT, light_ambient);  //주변광 성분 설정
	glLightfv(GL_LIGHT1, GL_DIFFUSE, light_diffuse);  //반사광 성분 설정
	glLightfv(GL_LIGHT1, GL_POSITION, light0_position);// 광원 위치 설정
	glEnable(GL_LIGHT1);
